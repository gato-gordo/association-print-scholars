<?php
	...
	<div id="pmpro_account">		
		<div id="pmpro_account-membership" class="pmpro_box">
			...
			<ul>
				<li>
					<strong><?php _e("Level", "pmpro");?>:</strong> <?php echo $current_user->membership_level->name?>
					<?php if(count($pmpro_levels) > 1 && !defined("PMPRO_DEFAULT_LEVEL")) { ?>
					<a href="<?php echo pmpro_url("levels")?>"><?php _e("(Change Membership Level)", "pmpro");?></a>
				<?php } ?>
				</li>
		...
		<div id="pmpro_account-profile" class="pmpro_box">	
			...
			<p>
				<a class="broken" href="<?php echo admin_url('profile.php')?>">Change Account Email</a> |
				<a class="broken" href="<?php echo admin_url('profile.php')?>"><?php _ex("Change Password", "As in 'change password'.", "pmpro");?></a>
			</p>
