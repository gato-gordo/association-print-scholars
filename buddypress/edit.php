...
if ( bp_has_profile( 'profile_group_id=' . bp_get_current_profile_group_id() ) ) :
		...
		while ( bp_profile_groups() ) : bp_the_profile_group(); ?>
			...
			<?php if (bp_get_current_profile_group_id() != 3): ?>
				...
				<div>
					<p>The information you enter will be visible publicly. You can modify your privacy settings by clicking on the red “change” links below. <span>Before navigating away from this tab, make sure to scroll down and save your changes.</span></p>
				</div>

				<?php while ( bp_profile_fields() ) : bp_the_profile_field(); ?>

					<?php if (bp_get_the_profile_field_name() == "Degree"){ ?>
						<h2>Education</h2>
					<?php } else if (bp_get_the_profile_field_name() == "Professional Affiliation: Title of your position/role") { ?>
					...
					<?php } else if (bp_get_the_profile_field_name() == "Research Description") { ?>
						<h2>Research</h2>
					<?php } else if (bp_get_the_profile_field_name() == "Mailing Address: Street") { ?>
